...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/worldcryptoforum-config.h \
           crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/worldcryptoforum-cli.cpp \
           src/worldcryptoforum-tx.cpp \
           src/worldcryptoforum.cpp \
           src/db.cpp \
           ...
           src/qt/worldcryptoforum.cpp \
           src/qt/worldcryptoforumstrings.cpp \
           ...
           src/test/test_worldcryptoforum.cpp \
...
RESOURCES += src/qt/worldcryptoforum.qrc src/qt/worldcryptoforum_locale.qrc

TRANSLATIONS += src/qt/locale/worldcryptoforum_bg.ts \
                src/qt/locale/worldcryptoforum_ca.ts \
                src/qt/locale/worldcryptoforum_cs.ts \
                src/qt/locale/worldcryptoforum_da.ts \
                src/qt/locale/worldcryptoforum_de.ts \
                src/qt/locale/worldcryptoforum_en.ts \
                src/qt/locale/worldcryptoforum_en_US.ts \
                src/qt/locale/worldcryptoforum_eo.ts \
                src/qt/locale/worldcryptoforum_es.ts \
                src/qt/locale/worldcryptoforum_es_ES.ts \
                src/qt/locale/worldcryptoforum_fi.ts \
                src/qt/locale/worldcryptoforum_fr.ts \
                src/qt/locale/worldcryptoforum_fr_FR.ts \
                src/qt/locale/worldcryptoforum_hi_IN.ts \
                src/qt/locale/worldcryptoforum_hr.ts \
                src/qt/locale/worldcryptoforum_hr_HR.ts \
                src/qt/locale/worldcryptoforum_it.ts \
                src/qt/locale/worldcryptoforum_ja.ts \
                src/qt/locale/worldcryptoforum_pl.ts \
                src/qt/locale/worldcryptoforum_ko_KR.ts \
                src/qt/locale/worldcryptoforum_lt_LT.ts \
                src/qt/locale/worldcryptoforum_nl.ts \
                src/qt/locale/worldcryptoforum_pl.ts \
                src/qt/locale/worldcryptoforum_pt.ts \
                src/qt/locale/worldcryptoforum_pt_BR.ts \
                src/qt/locale/worldcryptoforum_ro_RO.ts \
                src/qt/locale/worldcryptoforum_ru.ts \
                src/qt/locale/worldcryptoforum_sk.ts \
                src/qt/locale/worldcryptoforum_sv.ts \
                src/qt/locale/worldcryptoforum_tr.ts \
                src/qt/locale/worldcryptoforum_uk.ts \
                src/qt/locale/worldcryptoforum_vi.ts \
                src/qt/locale/worldcryptoforum_zh_CN.ts \
                src/qt/locale/worldcryptoforum_zh_TW.ts