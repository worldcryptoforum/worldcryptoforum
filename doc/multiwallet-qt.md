...
In order to support loading of multiple wallets in worldcryptoforum-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is worldcryptoforum.cpp.
...
Changes to worldcryptoforum.cpp
----------------------
worldcryptoforum.cpp is the entry point into worldcryptoforum-qt, and as such, will require some minor modifications to provide hooks for
