...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WCF features */
        {"worldcryptoforum", "masternode", &masternode, true, true, false},
        {"worldcryptoforum", "masternodelist", &masternodelist, true, true, false},
        {"worldcryptoforum", "mnbudget", &mnbudget, true, true, false},
        {"worldcryptoforum", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"worldcryptoforum", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"worldcryptoforum", "mnsync", &mnsync, true, true, false},
        {"worldcryptoforum", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use worldcryptoforumd, or the -server option to worldcryptoforum-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> worldcryptoforum-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:11007/\n";
}
