...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("WCF Core worldcryptoforum-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  worldcryptoforum-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded worldcryptoforum transaction") + "\n" +
                               "  worldcryptoforum-tx [options] -create [commands]   " + _("Create hex-encoded worldcryptoforum transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded worldcryptoforum transaction
