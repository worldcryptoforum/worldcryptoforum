...
// Copyright (c) 2015-2016 The Worldcryptoforum developers
...
private:
    ...
    /// Get 10000 WCF input that can be used for the Masternode
...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 WCF - checking if valid masternode)
