...
/** Utility functions used by the WCF Qt UI.
 */
namespace GUIUtil
{
...
// Render WCF addresses in monospace font
...
// Parse "worldcryptoforum:" URI into recipient object, return true on successful parsing
