                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("WCF-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a WCF address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and worldcryptoforum: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About WCF Core"), this);
    aboutAction->setStatusTip(tr("Show information about WCF Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for WCF"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your WCF addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified WCF addresses"));
    ...
    openAction->setStatusTip(tr("Open a WCF: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the WCF Core help message to get a list with possible WCF command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("WCF Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to WCF network", "", count));
}
...
{
    QString strTitle = tr("WCF Core"); // default title
