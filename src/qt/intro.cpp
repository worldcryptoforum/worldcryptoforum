...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("WCF Core"),
     ...
     * override -datadir in the worldcryptoforum.conf file in the default data directory
     * (to be consistent with worldcryptoforumd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
